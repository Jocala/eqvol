...
public class EQVClient {
  ...
  public static func fromDictionary (_ dict: [String: Any]) -> EQVClient? {
    guard
    ...
    return EQVClient(clientId: clientId, processId: processId, bundleId: bundleId, volume: volume)
  }
}
