...
let kEQVDeviceDefaultName = "DELL U3818DW (eqVol)"
let kDeviceManufacturer = "Jocala Software"

let kDeviceUID = "EQVolDevice"
let kDeviceModelUID = "EQVDeviceModelUID"

let kDefaultSampleRate: Float64 = kEQVDeviceSupportedSampleRates[0]
